...
/* ─── Asset URLs ──────────────────────────────────────────── */
const ASSETS = {
  iconSaveMore:    "https://www.figma.com/api/mcp/asset/fd5e8bca-597a-4e35-a403-89532a337f10",
  iconLoadShed:    "https://www.figma.com/api/mcp/asset/3de26d2a-bcb4-42ae-8950-daade5e70cee",
  iconEco:         "https://www.figma.com/api/mcp/asset/62fa0322-1059-4c38-ae18-881249e9752e",
          ...
          <div className="bg-gradient-to-br from-[#efaf0a] to-[#f59e0b] rounded-3xl overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
              ...
              <div className="bg-white dark:bg-[#1e2a3d] px-8 sm:px-10 py-12 lg:py-14 flex flex-col gap-5 rounded-3xl lg:rounded-l-none lg:rounded-r-3xl shadow-xl">
                ...
                <button className="w-full bg-[#111827] dark:bg-[#efaf0a] text-white dark:text-[#3d2700] font-bold text-[15px] py-3.5 rounded-xl shadow-lg hover:bg-[#1f2937] dark:hover:bg-[#d9a008] active:scale-[0.98] transition-all mt-1">
